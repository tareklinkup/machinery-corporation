...
(function ($) {
    ...
    $.fn.numpad = function (options) {
        ...
        return this.each(function () {
            ...
            if ($('#' + id).length == 0) {
                ...
                nmpd.grid = table;
                table.append(
                  $("<colgroup></colgroup>").append($("<col></col>").css('width', options.ButtonSize))
                  .append($("<col></col>").css('width', options.ButtonSize))
                  .append($("<col></col>").css('width', options.ButtonSize))
                  )
                ...
                // Create rows and columns of the the grid with appropriate buttons
                    ...
                    table.append(
                    $(options.rowTpl)
						.append($(options.cellTplColSpan2).css('height', options.ButtonSize).append($(options.buttonFunctionTpl).html('Delete').addClass('del').click(function () {
						    nmpd.setValue(nmpd.getValue().toString().substring(0, nmpd.getValue().toString().length - 1));
						})))
                        .append($(options.cellTpl).append($(options.buttonFunctionTpl).html('C').addClass('clear').click(function () {
                            nmpd.setValue('');
                        })))
					).append(
					$(options.rowTpl)
						.append($(options.cellTpl).css('height', options.ButtonSize).append($(options.buttonNumberTpl).html(7).addClass('numero')))
					...
					$(options.rowTpl)
						.append($(options.cellTpl).css('height', options.ButtonSize).append($(options.buttonNumberTpl).html(4).addClass('numero')))
					...
					$(options.rowTpl)
						.append($(options.cellTpl).css('height', options.ButtonSize).append($(options.buttonNumberTpl).html(1).addClass('numero')))
					...
					$(options.rowTpl)
						.append($(options.cellTplColSpan2).css('height', options.ButtonSize).append($(options.buttonNumberTpl).html(0).addClass('numero')))
	...
	*/
    ...
    $.fn.numpad.defaults = {
        ...
        cellTplColSpan2: '<td colspan="2"></td>',
        rowTpl: '<tr></tr>',
        cellTpl: '<td></td>',
