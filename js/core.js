$(document).ready(function () {
    ...
    $("div.pane h2 a.no-collapse").click(function () {
        $(this).closest("h2").next().toggle();
    });
    ...
    $("input.merge").click(function () {
        var valid = confirm("Are you sure you want to merge those records ?");
        return valid;
    });
    ...
    $('.inventory-by input[type=radio]').change(function () {
