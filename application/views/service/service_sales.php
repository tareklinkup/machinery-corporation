...
<h2>Sales Service<span style="float:right"><a class="buttonAshiqe" href="<?php echo base_url(); ?>service/viewAllService">View Service</a></span></h2>
            ...
            <table width="100%"> 
                <tr>
                    ...
                    <div class="full clearfix">
                        <input type="text" name="serviceInvoice" class="inputclass" id="serviceInvoice" style="width:200px" value="">
                    </div></td>
                    <td>User</td>
                    <td>
                    <div class="full clearfix">
                    ...
                    <div class="full clearfix" id="ashiqeCalender">
                        <input name="service_date" id="service_date" type="text" value="<?php echo date("Y-m-d") ?>" class="inputclass" style="width:200px"/>
                    </div></td>
                </tr>
                <tr>
                    <td>PO NO</td>
        ...
        <fieldset>
            ...
            <table width="100%"> 
                ...
                <tr>
                    <td>Transport<br>
                    <div class="full clearfix">
                        <input type="hidden" id="vatPersent" class="inputclass" style="width:50px" value="0"> 
                ...
                <tr>
                    <td><input type="button" class="buttonAshiqe" onclick="SalseToCart()" value="Sell" style="width:50px" id="sellbtn">
...
<script type="text/javascript">
    function SalseToCart(){
        var packagename = $("#packagename").val();
        var salesInvoiceno = $("#serviceInvoice").val();
        if(salesInvoiceno == ""){
            $("#serviceInvoice").css("border-color","red");
            return false;
        }
        var pono = $("#PoNo").val();
        if(pono == ""){
        ...
        var sales_date = $("#service_date").val();
        ...
        var urldata = "<?php echo base_url(); ?>service/service_order/";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
            success:function(data){
                ...
                if(err){
                    if(confirm('Show Report')){
                        window.location.href='<?php echo base_url(); ?>service/serviceAndPrint';
                    }else{
