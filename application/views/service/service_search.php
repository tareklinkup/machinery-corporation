...
<a style="cursor:pointer" onclick="window.open('<?php echo base_url(); ?>reports/service_search', 'newwindow', 'width=850, height=800,scrollbars=yes'); return false;"><img src="<?php echo base_url(); ?>images/printer.png" alt=""> Print</a>
