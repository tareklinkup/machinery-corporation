...
<script type="text/javascript">
    function ChallanToCart(){
        ...
        var urldata = "<?php echo base_url(); ?>service/challan_order/";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
            success:function(data){
                ...
                if(err){
                    if(confirm('Show Report')){
                        window.location.href='<?php echo base_url(); ?>service/challanAndPrint';
                    }else{
                        alert('Challan Success');
                        window.location.href='<?php echo base_url(); ?>service/challan';
                        return false;
                    }
                }
