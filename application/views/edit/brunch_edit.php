            ...
            <div id="tabs" class="clearfix moderntabs">
                <div id="tabs-1">
                        ...
                        <div class="middle_form">
                            <h2 id="">Update Branch<span style="color:green;float:right"><?php $status = $this->session->userdata('Brunch');if(isset($status))echo $status;$this->session->unset_userdata('Brunch'); ?></span>
                            ...
                            <div class="body">
                                <div class="full clearfix">
                                    ...
                                    <div class="left">                                      
                                        <input name="Brunchname" type="text" id="Brunchname" class="required" value="<?php echo $selected['Brunch_name'] ?>" required/>
                                ...
                                <div class="full clearfix">
                                    <div class="section_right clearfix">
                                        ...
                                        <a href="<?php echo base_url() ?>page/brunch" class="button">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
