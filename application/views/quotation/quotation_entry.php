...
<h2><?= $title?></h2>
    <div style="width:78%; float:left;">
            ...
            <table width="100%">
                <tr>
                    ...
                    <div class="full clearfix">
                        ...
                        $maxid = mysql_result(mysql_query("SELECT MAX(SaleMaster_SlNo) FROM sr_quotationmaster"), 0);
                        $sn = ($maxid+1);
        ...
        <table width="100%" style="float-left">
                ...
                <td style="border: 1px solid #ddd;"><!-- Product area -->
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="width:200px">
                                <div class="full clearfix">
                                    <textarea class="inputclass" rows="1" id="product_description" name="product_description" placeholder="Product Description"></textarea>
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <div class=" clearfix" style="margin-top:20px;padding-bottom:0px;">
            ...
            <div class="clearfix moderntabs" style="width:100%;max-height:100px;min-height:100px;overflow:auto;">
               ...
               <?php  if ($cart = $this->cart->contents()): ?>
                   <table class="zebra" cellspacing="0" cellpadding="0" border="0" id="" style="text-align:left;width:100%;border-collapse:collapse;">
                            ...
                            foreach ($cart as $item):
                                ...
                                echo form_hidden('cart[' . $item['id'] . '][product_description]', $item['product_description']);
...
<script type="text/javascript">
    function ADDTOCART(){
        ...
        var inputdata = 'packagecode='+packagecode+'&packagename='+packagename+'&ProID='+ProID+'&proName='+proName+'&product_description='+product_description+'&proQTY='+proQTY+'&ProRATe='+ProRATe+'&unit='+unit+'&ProPurchaseRATe='+ProPurchaseRATe;
...
<script type="text/javascript">
    function SalseToCart(){
        ...
        var urldata = "<?php echo base_url(); ?>quotation/quotation_create/";
            ...
            success:function(data){
                ...
                if(err){
                    if(confirm('Show Report')){
                        window.location.href='<?php echo base_url(); ?>quotation/sellAndPrint';
                    }else{
