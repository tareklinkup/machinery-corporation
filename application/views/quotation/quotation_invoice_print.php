...
FROM sr_quotationmaster left join tbl_quotaion_customer on tbl_quotaion_customer.	quotation_customer_id = sr_quotationmaster.SalseCustomer_IDNo 
where sr_quotationmaster.SaleMaster_SlNo = '$id'
        ");
                        ...
                        <table width="100%">
                            ...
                            if($cusID == 0){
                                ...
                                <tr>
                                    ...
                                    <td style="border:0px;font-size:11pt;"><?php echo $selse['quotation_customer_id']; ?></td>
        ...
        <td>
            ...
            <table class="border" cellspacing="0" cellpadding="0" width="100%">
                ...
                <tr>
                    ...
                    <td style="border:0px;color:red;text-align: right;"><?php
                        // if($CurrenDue==''){echo '0.00';}else{echo number_format($CurrenDue, 2);}
                        ?></td>
                ...
                <tr>
                    ...
                    <td style="color:red;border-top: 1px solid #999;border-left: 0px ;border-right: 0px ;border-bottom: 0px ;text-align: right;"><?php
                        // if($previousdue+$CurrenDue==''){echo '0.00';}else{echo number_format(($previousdue+$CurrenDue), 2);}
                         ?></td>
