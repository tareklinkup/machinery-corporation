...
<div class="content_scroll" style="padding:40px 20px 25px 160px">
    <a style="cursor:pointer" onclick="window.open('<?php echo base_url(); ?>quotation/quotationPrint', 'newwindow', 'width=850, height=800,scrollbars=yes'); return false;"><img src="<?php echo base_url(); ?>images/printer.png" alt=""> Print</a>

    <?php
    $sql = mysql_query("
                                      SELECT sr_quotationmaster.*, sr_quotationmaster.AddBy as served, tbl_quotaion_customer.* 
                                      FROM sr_quotationmaster 
                                      left join tbl_quotaion_customer on tbl_quotaion_customer.quotation_customer_id = sr_quotationmaster.SalseCustomer_IDNo 
                                      where sr_quotationmaster.SaleMaster_SlNo = '$SalesID'
                                      ");
                ...
                <table width="100%">
                    ...
                    if($cusID == 0){
                        ...
                        <tr>
                            <td><strong>Customer ID </strong></td>
                            <td>:</td>
                            <td><?php echo $selse['quotation_customer_id']; ?></td>
                        </tr>
                        <tr>
                            <td><strong>Customer Name </strong></td>
                            <td>:</td>
