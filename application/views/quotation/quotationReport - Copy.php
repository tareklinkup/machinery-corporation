...
<a style="cursor:pointer" onclick="window.open('<?php echo base_url();?>Administrator/quotation/quotationPrint', 'newwindow', 'width=850, height=800,scrollbars=yes'); return false;"><img src="<?php echo base_url(); ?>images/printer.png" alt=""> Print</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="<?php echo base_url();?>Administrator/quotation" title="" class="buttonAshiqe">Back To Memo</a>
...
<table  cellspacing="0" cellpadding="0" width="700">
    ...
    <table class="border" cellspacing="0" cellpadding="0" width="700">
        ...
        <?php } }
            $ssqls = mysql_query("SELECT tbl_quotation_details.*, tbl_product.*  FROM tbl_quotation_details left join tbl_product on tbl_product.Product_SlNo = tbl_quotation_details.Product_IDNo where tbl_quotation_details.SaleMaster_IDNo = '$SalesID' group by tbl_quotation_details.packageName");
