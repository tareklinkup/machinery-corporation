    ...
    <table width="800px" >
        ...
        <tr>
           ...
           $id = $this->session->userdata('lastwhid');
            $sql = mysql_query("SELECT sr_warehouse_master.*, sr_warehouse_master.AddBy as served, sr_customer.* FROM sr_warehouse_master left join sr_customer on sr_customer.Customer_SlNo = sr_warehouse_master.SalseCustomer_IDNo where sr_warehouse_master.WHMaster_SlNo = '$id'");
        ...
        $ssql = mysql_query("SELECT sr_warehouse_details.*, tbl_product.*  FROM sr_warehouse_details left join tbl_product on tbl_product.Product_SlNo = sr_warehouse_details.Product_IDNo where sr_warehouse_details.WHMaster_IDNo = '$id'");
        ...
        <?php } }
            ...
            $ssqls = mysql_query("SELECT sr_saledetails.*, tbl_product.*  FROM sr_saledetails left join tbl_product on tbl_product.Product_SlNo = sr_saledetails.Product_IDNo where sr_saledetails.SaleMaster_IDNo = '$id' group by sr_saledetails.packageName");
        ...
        <tr><td  style="border:0px"></td>
            ...
            <td  style="border:0px;color:red;">
                ...
                <?php $cusotomerID = $selse['Customer_SlNo']; 
                    ...
                    $sqls = mysql_query("SELECT * FROM sr_warehouse_master WHERE SalseCustomer_IDNo = '".$cusotomerID."'");
