      ...
      <table width="800px" >
        ...
        <tr>
          ...
          <?php 
            ...
            $sql = mysql_query("SELECT sr_purchasemaster.*, sr_purchasemaster.AddBy as served, sr_supplier.* FROM sr_purchasemaster left join sr_supplier on sr_supplier.Supplier_SlNo = sr_purchasemaster.Supplier_SlNo where sr_purchasemaster.PurchaseMaster_SlNo = '$id'");
                  ...
                  <td style="width:50%;">
                      ...
                      <table width="100%">
                          ...
                          <tr>
                              ...
                              <td style="border:0px;font-size:11pt;"><strong>Supplier ID </strong></td>

                              <td style="border:0px;font-size:11pt;">:</td>

                              <td style="border:0px;font-size:11pt;"><?php echo $selse['Supplier_Code']; ?></td>

                          </tr> 

                          <tr>

                              <td style="border:0px;font-size:11pt;"><strong>Supplier Name </strong></td>

                              <td style="border:0px;font-size:11pt;">:</td>

                              <td style="border:0px;font-size:11pt;"><?php echo $selse['Supplier_Name']; ?></td>

                          </tr> 

                          <tr>

                              <td style="border:0px;font-size:11pt;"><strong>Customer Address </strong></td>

                              <td style="border:0px;font-size:11pt;">:</td>

                              <td style="border:0px;font-size:11pt;"><?php echo $selse['Supplier_Address']; ?></td>

                          </tr>

                          <tr>

                              <td style="border:0px;font-size:11pt;"><strong>Contact no </strong></td>

                              <td style="border:0px;font-size:11pt;">:</td>

                              <td style="border:0px;font-size:11pt;"><?php echo $selse['Supplier_Mobile']; ?></td>
                  ...
                  <td style="width:50%;">
                      ...
                      <table width="100%">
                          ...
                          <tr>
                              ...
                              <td style="border:0px;font-size:11pt;"><strong>Invoice No </strong></td>

                              <td style="border:0px;font-size:11pt;">:</td>

                              <td style="border:0px;font-size:11pt;"><?php echo $selse['PurchaseMaster_InvoiceNo']; ?></td>

                          </tr> 

                          <tr>

                              <td style="border:0px;font-size:11pt;"><strong>Purchase Date </strong></td>

                              <td style="border:0px;font-size:11pt;">:</td>

                              <td style="border:0px;font-size:11pt;"><?php echo $selse['PurchaseMaster_OrderDate']; ?></td>

                          </tr> 

                          <tr>

                              <td style="border:0px;font-size:11pt;"><strong>Purchase By </strong></td>

                              <td style="border:0px;font-size:11pt;">:</td>

                              <td style="border:0px;font-size:11pt;"><?php echo $this->session->userdata("FullName"); ?></td>
        ...
        $ssql = mysql_query("SELECT sr_purchasedetails.*, tbl_product.* FROM sr_purchasedetails left join tbl_product on tbl_product.Product_SlNo = sr_purchasedetails.Product_IDNo where sr_purchasedetails.PurchaseMaster_IDNo = '$id'");
        ...
        <tr>
            ...
            <td align="center"><?php echo $rows['PurchaseDetails_TotalQuantity']; ?>

            <?php echo $rows['PurchaseDetails_Unit']; ?></td>

            <td align="center"><?php echo $rows['PurchaseDetails_Rate'] ?></td>
        ...
        <?php } }
            ...
            $ssqlx = mysql_query("SELECT sr_purchasedetails.*, tbl_product.* FROM sr_purchasedetails left join tbl_product on tbl_product.Product_SlNo = sr_purchasedetails.Product_IDNo where sr_purchasedetails.PurchaseMaster_IDNo = '$id' group by sr_purchasedetails.PackName");
