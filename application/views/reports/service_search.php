...
<input name="print" type="button" value="Print" id="printButton" onClick="printpage()">
      ...
      <table width="800px" style="margin-top:-20px;">
        ...
        <tr>
           ...
           <?php 
           $SMSearchID = $this->session->userdata("SMSearchID");
            $sql = mysql_query("SELECT sr_servicemaster.*, sr_servicemaster.AddBy as served, sr_customer.* FROM sr_servicemaster left join sr_customer on sr_customer.Customer_SlNo = sr_servicemaster.Customer_IDNo where sr_servicemaster.ServiceMaster_SlNo = '$SMSearchID'");
                  ...
                  <td style="width:50%">
                   ...
                   <table width="100%">
                    ...
                    <tr>
                        ...
                        <td style="border:0px;font-size:11pt;"><?php echo $selse['ServiceMaster_InvoiceNo']; ?></td>
                    ...
                    <tr>
                        ...
                        <td style="border:0px;font-size:11pt;"><?php echo $selse['ServiceMaster_SaleDate']; ?></td>

                    </tr>

                    <tr>

                        <td style="border:0px;font-size:11pt;width:135px;"><strong>PO No </strong></td>

                        <td style="border:0px;font-size:11pt;">:</td>

                        <td style="border:0px;font-size:11pt;"><?php echo $selse['Po_No']; ?></td>

                    </tr> 

                    <tr>

                        <td style="border:0px;font-size:11pt;width:135px;"><strong>Delivery Invoice No </strong></td>

                        <td style="border:0px;font-size:11pt;">:</td>

                        <td style="border:0px;font-size:11pt;"><?php echo $selse['Delevary_Invoice_No']; ?></td>
        ...
        $ssql = mysql_query("SELECT sr_servicedetails.*, tbl_product.*  FROM sr_servicedetails left join tbl_product on tbl_product.Product_SlNo = sr_servicedetails.Product_IDNo where sr_servicedetails.ServiceMaster_IDNo = '$SMSearchID'");
        ...
        <tr>
            ...
            <td align="center"><?php echo $rows['ServiceDetails_TotalQuantity'] ?> <?php echo $rows['ServiceDetails_unit'] ?></td>

            <td align="center"><?php echo $rows['ServiceDetails_Rate'] ?></td>
        ...
        <?php } }
            ...
            $ssqls = mysql_query("SELECT sr_servicedetails.*, tbl_product.*  FROM sr_servicedetails left join tbl_product on tbl_product.Product_SlNo = sr_servicedetails.Product_IDNo where sr_servicedetails.ServiceMaster_IDNo = '$SMSearchID' group by sr_servicedetails.packageName");
            ...
            <tr>
                ...
                <td align="center"><?php echo $rows['ServiceDetails_qty'] ?> <?php echo $rows['ServiceDetails_unit'] ?></td>
        ...
        <tr><td  style="border:0px"></td>
            ...
            <td  style="border:0px;color:red;">
                ...
                <?php 
                    ...
                    $cusotomerID = $selse['Customer_SlNo']; 
...
?>
    ...
    <h4>Notes: <?php echo $selse['ServiceMaster_Description']; ?></h4>
