      ...
      <table width="800px" style="margin-top:-20px;">
        ...
        <tr>
           ...
           <?php 
            ...
            $sql = mysql_query("SELECT sr_servicemaster.*, sr_servicemaster.AddBy as served, sr_customer.* FROM sr_servicemaster left join sr_customer on sr_customer.Customer_SlNo = sr_servicemaster.Customer_IDNo where sr_servicemaster.ServiceMaster_SlNo = '$id'");
        ...
        $ssql = mysql_query("SELECT sr_servicedetails.*, tbl_product.*  FROM sr_servicedetails left join tbl_product on tbl_product.Product_SlNo = sr_servicedetails.Product_IDNo where sr_servicedetails.ServiceMaster_IDNo = '$id'");
        ...
        <?php } }
            ...
            $ssqls = mysql_query("SELECT sr_servicedetails.*, tbl_product.*  FROM sr_servicedetails left join tbl_product on tbl_product.Product_SlNo = sr_servicedetails.Product_IDNo where sr_servicedetails.ServiceMaster_IDNo = '$id' group by sr_servicedetails.packageName");
