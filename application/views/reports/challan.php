      ...
      <table width="800px" >
        ...
        <tr>
           ...
           <?php 
            ...
            $sql = mysql_query("SELECT sr_challanmaster.*, sr_challanmaster.AddBy as served, sr_customer.* FROM sr_challanmaster left join sr_customer on sr_customer.Customer_SlNo = sr_challanmaster.Customer_IDNo where sr_challanmaster.ChallanMaster_SlNo = '$id'");
                  ...
                  <td style="width:50%;">
                   <table width="100%">
                    <tr>
                        ...
                        <td style="border:0px;font-size:11pt;">:</td>
                        <td style="border:0px;font-size:11pt;"><?php echo $selse['ChallanMaster_ChallanNo']; ?></td>
                    </tr> 

                    <tr>
                        <td style="border:0px;font-size:11pt;width:135px;"><strong>Date </strong></td>
                        <td style="border:0px;font-size:11pt;">:</td>
                        <td style="border:0px;font-size:11pt;"><?php echo $selse['ChallanDate']; ?></td>
                    </tr>
        ...
        $ssql = mysql_query("SELECT sr_challandetails.*, tbl_product.*  FROM sr_challandetails left join tbl_product on tbl_product.Product_SlNo = sr_challandetails.Product_IDNo where sr_challandetails.ChallanMaster_SlNo = '$id'");
        ...
        <?php } }
            ...
            $ssqls = mysql_query("SELECT sr_challandetails.*, tbl_product.*  FROM sr_challandetails left join tbl_product on tbl_product.Product_SlNo = sr_challandetails.Product_IDNo where sr_challandetails.ChallanMaster_SlNo = '$id' group by sr_challandetails.packageName");
