    ...
    <table class="border" cellspacing="0" cellpadding="0" width="70%">
        ...
        <tr>
            ...
            <td style="border:0px;color:red; text-align: right;"><?php
                if ($cusID !=0):
                    if($CurrenDue==''){echo '0';} echo $CurrenDue;
                endif;
                ?>
            </td>
            <td style="border:0px"></td>
        ...
        <tr>
            ...
            <td style="color:red;text-align: right;border-left: 0px ;border-right: 0px ;border-bottom: 0px ;">
                <?php
                if ($cusID !=0):
                    if($previousdue+$CurrenDue==''){echo '0';} echo $previousdue+$CurrenDue;
                endif;
                ?>
