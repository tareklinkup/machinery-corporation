                ...
                <tr>
                    ...
                    <td>
                        <div class="side-by-side clearfix">
                            <div>
                                <select id="SaleMasteriD" data-placeholder="Choose a Product..." class="chosen-select" style="width:250px;" tabindex="2" >
                                     <option value=""></option>
...
<script type="text/javascript">
  function searchforreturn(){
    ...
    var urldata = "<?php echo base_url(); ?>sales/sales_invoice_search_due";
    $.ajax({
        type: "POST",
        url: urldata,
        data: inputData,
