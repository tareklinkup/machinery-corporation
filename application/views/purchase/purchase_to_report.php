...
<a href="<?php echo base_url(); ?>purchase" title="" class="buttonAshiqe">Back To Purchase</a>
<br>
<br>
<?php 
        ...
        <tr>
            ...
            <td>
                <table width="100%">
                    ...
                    <tr>
                        <td><strong>Purchase By </strong></td>
                        <td>:</td>
    ...
    <table class="border" cellspacing="0" cellpadding="0" width="70%">
        ...
        <tr>
         ...
         <tr>
            ...
            <td style="border:0px"align="right"><strong><?php $grandtotal = $totalamount-$discount+ $Frieght+$vat; echo number_format($grandtotal,2)?></strong></td>
