...
<head>
    ...
    <title>
        ...
        NEW JES MACHINERY CORPORATION | <?php echo $title; ?>
...
<div id="preloader"></div>
    ...
    <div class="container">
        ...
        <header>
            ...
            <div class="account">
                ...
                <span>NEW JES MACHINERY CORPORATION</span>

            </div>

            <div class="status_bar">

                <input id="txtSearch" type="text" placeholder="Search" value="" />
                <?php
    ...
    <div id="LoadingDiv" style="width: 100%;text-align: center;position: absolute;top: 35%;left: 10%;">
        <p><img src="<?php echo base_url(); ?>images/loading.gif"></p>
    </div>
    <script type="text/javascript">
        $( document ).ready(function() {
        $('#LoadingDiv').hide();
        $(document).ajaxStart(function(){
            $('#LoadingDiv').show();
            $(".buttonAshiqe").prop('disabled', true);
        });
        $(document).ajaxStop(function(){
            $('#LoadingDiv').hide();
            $(".buttonAshiqe").removeAttr('disabled', false);
        });
    });
    </script>
