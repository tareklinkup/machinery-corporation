...
<html>
    <head>
        ...
        <style type="text/css">
           .article{min-height:90px;max-height:100px;width:15px;float:left;writing-mode: tb-rl;}
        ...
        //    location.reload();
                ...
                let printContent = document.querySelector('#barcodes').innerHTML;
                let printWindow = window.open('', 'barcodes', `width=${screen.width}, height=${screen.height}`);
    ...
    <div class="container-fluid">
            ...
            <section class="" id="printButton" style="background:#f4f4f4;height:200px;">
             <div class="">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2"> 
                    <input type="text" name="pID" class="form-control mytext" placeholder="Product ID ..." value="<?php echo $product->P_Code; ?>" />
                </div>
        ...
        <div class="row">
            <div class="output col-md-8 col-md-offset-2">
                <section class="output" id="barcodes">
                    <?php 
                    ...
                    ?>
                        <div style="width:151.18110236px;height:113px;box-sizing:border-box;padding:2px;float:left;overflow:hidden;">
                            <table style="border-collapse:collapse;width: 100%;">
                                <tr>
                                    <td><span style="writing-mode: tb-rl;font-size:10px;"><?php echo $article; ?></span></td>
                                    <td style="text-align:center;">
                                        <span style="font-size: 9px;display:block;word-break: break-all;width:100px;margin:0 auto;"><?php echo $pname; ?></span>
                                        <img src="<?= base_url(); ?>/barcode/barcode.php?codetype=code128&size=40&text=<?= $product->P_Code?>"style="height: 50px; width: 100px;" />
                                        <p style="font-size:10px; padding: 0px; margin:0px;"><?php echo $product->P_Code; ?></p>
                                        <span style="margin-top: 0px;font-size:12px;"><?php echo 'TK. '.$Price;?></span>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <!-- <div style="padding: 2px; float: left; height: 100px; width: 151px; border: 1px solid #ddd;box-sizing:border-box;">
